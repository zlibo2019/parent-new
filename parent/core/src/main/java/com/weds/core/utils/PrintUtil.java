...
public class PrintUtil {
    ...
    // 竖屏模式
    private static OrientationRequested PORTRAIT = OrientationRequested.PORTRAIT;
    // 横屏模式
    private static OrientationRequested LANDSCAPE = OrientationRequested.LANDSCAPE;
     ...
     * @param height
     */
    public static void printSale(Printable printable, int width, int height) {
        try {
            // 通俗理解就是书、文档
            Book book = new Book();
            // 设置成竖打
