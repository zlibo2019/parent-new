...
import com.weds.core.annotation.Excel;
import com.weds.core.annotation.Excel.Type;
import com.weds.core.annotation.Excels;
 ...
 * Excel相关处理
 */
public class ExcelHandleUtils<T> {
    ...
    public ExcelHandleUtils(Class<T> clazz) {
        this.clazz = clazz;
    }
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StringUtils.endsWith(s, ".0")) {
                            ...
                            if (StringUtils.isNotEmpty(dateFormat)) {
                                val = DateUtils.formatDate((Date) val, dateFormat);
                            } else {
     ...
     * @return 结果
     */
    public JsonResult exportExcel(List<T> list, String sheetName, String path) {
     ...
     * @return 结果
     */
    public JsonResult importTemplateExcel(String sheetName, String path) {
     ...
     * @return 结果
     */
    public JsonResult exportExcel(String path) {
        ...
        try {
            ...
            wb.write(out);
            return JsonResult.get(CoreConstants.SUCCESSED_FLAG, filename);
        } catch (Exception e) {
     ...
     * @param filename 文件名称
     */
    public String getAbsoluteFile(String filename, String path) {
